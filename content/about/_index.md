...
## 站点主题是什么?
很多人问我站点主题的事情,这一套的站点主题是 `cactus-dark`,是hexo的一套皮肤.

## Hugo版本的`cactus-dark`主题
因为hexo的性能问题,我把页面生成器换成了 `Hugo`,所以现在这套皮肤现在我是重新用Go模板写的.
如果有hugo的小伙伴想要这套主题,在下方留言,

如果你需要的话,我会抽时间整理一套Hugo的`cactus-dark`主题.
